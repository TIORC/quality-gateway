...
export type PlanoOrigemRow = Database["public"]["Tables"]["plano_origens"]["Row"];
export type PlanoOrigemInsert = Database["public"]["Tables"]["plano_origens"]["Insert"];
export type PlanoOrigemUpdate = Database["public"]["Tables"]["plano_origens"]["Update"];
export type PlanoComentarioRow = Database["public"]["Tables"]["plano_comentarios"]["Row"];
export type PlanoComentarioInsert = Database["public"]["Tables"]["plano_comentarios"]["Insert"];
export type PlanoComentarioUpdate = Database["public"]["Tables"]["plano_comentarios"]["Update"];
export type PlanoHistoricoRow = Database["public"]["Tables"]["plano_historico"]["Row"];
export type PlanoHistoricoInsert = Database["public"]["Tables"]["plano_historico"]["Insert"];
export type PlanoHistoricoUpdate = Database["public"]["Tables"]["plano_historico"]["Update"];
...
export type PoliticaLeituraRow = Database["public"]["Tables"]["politica_leituras"]["Row"];
export type PoliticaLeituraInsert = Database["public"]["Tables"]["politica_leituras"]["Insert"];
export type PoliticaSugestaoRow = Database["public"]["Tables"]["politica_sugestoes"]["Row"];
export type PoliticaSugestaoInsert = Database["public"]["Tables"]["politica_sugestoes"]["Insert"];
